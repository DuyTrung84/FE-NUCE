...
const UpdateDoctor = () => {
    ...
    useEffect(() => {
        form.setFieldsValue({
            ...
            clinicsId: { key: doctorData?.data?.clinicId, label: doctorData?.data?.clinicName },
        });
        if (doctorData?.data?.imageUrl) {
            setImageUrl(doctorData?.data?.imageUrl);
        }
        if (doctorData?.data?.district && doctorData?.data?.province) {
            setSelectedDistricts(doctorData?.data?.district || "");
            setSelectedProvince(doctorData?.data?.province || "");
        }
    }, [doctorData, form, setSelectedDistricts, setSelectedProvince]);
                ...
                >
                    ...
                    <Row gutter={26}>
                        ...
                        <Col span={24}>
                            ...
                            >
                                <Input placeholder="Địa chỉ" className="p-2" />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item
                            ...
                            >
                                <Select placeholder="---Select---" className="w-full h-10" loading={loadingClinics}                                    >
                        ...
                        <Col span={12}>
                            ...
                            >
                                <Select placeholder="---Select---" className="w-full h-10" loading={loadingSpecialty}>
