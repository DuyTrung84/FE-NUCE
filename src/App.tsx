...
const BookingConfig = React.lazy(() => import('./pages/doctor/BookingConfigManage/BookingConfig'));
const BookingConfigAdd = React.lazy(() => import('./pages/doctor/BookingConfigManage/BookingConfigAdd'));
const BookingConfigUpdate = React.lazy(() => import('./pages/doctor/BookingConfigManage/BookingConfigUpdate'));
const Configweek = React.lazy(() => import('./pages/doctor/Configweek/Configweek'));
          ...
          <Routes>
            ...
            <Route element={<IsCheckDoctor />}>
              <Route path="/doctor" element={<LayoutDoctor />}>
                ...
                <Route path='cau-hinh-lich/bac-si/:idDoctor' element={<BookingConfig />} />
                <Route path='cau-hinh-lich/dich-vu/:idDoctor' element={<BookingConfig />} />
                <Route path='them-cau-hinh-lich/:idDoctor' element={<BookingConfigAdd />} />
                <Route path='sua-cau-hinh-lich/:idDoctor/:id' element={<BookingConfigUpdate />} />
                <Route path='cau-hinh-ngay-trong-tuan/bac-si/:idDoctor' element={<Configweek />} />
                <Route path='cau-hinh-ngay-trong-tuan/dich-vu/:idDoctor' element={<Configweek />} />
              </Route>
            </Route>
