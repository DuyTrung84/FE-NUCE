...
import configBookingApi, { configBookingApiReducer } from '../api/site/ConfigBooking';
...
export interface RootState {
    ...
    [configBookingApi.reducerPath]: ReturnType<typeof configBookingApiReducer>;
}
...
const rootReducer = combineReducers<RootState>({
    ...
    [configBookingApi.reducerPath]: configBookingApiReducer,
})
